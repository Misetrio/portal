 ...
 * Set import files
 */
function subscribe_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Demo content', 'subscribe'),
...
add_filter( 'pt-ocdi/import_files', 'subscribe_set_import_files' );

/**
 * Define actions that happen after import
 */
function subscribe_set_after_import_mods() {
...
add_action( 'pt-ocdi/after_import', 'subscribe_set_after_import_mods' );
