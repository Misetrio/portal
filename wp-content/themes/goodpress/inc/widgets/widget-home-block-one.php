...
class goodpress_Block_One_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			...
			'description' => __( 'Display one-column post blocks. Only use for the "Homepage Content" widget area.', 'goodpress' )
		);

		// Create the widget.
		parent::__construct(
			'happythemes-home-block-one',          // $this->id_base
			__( '&raquo; Home One Column Type A', 'goodpress' ), // $this->name
