				...
				<div class="trip-metas">
					<div class="clearfix title-price-wrapper" >
						...
						<span class="trip-price">						
							<span class="current-price">
								<?php if ( true == $enable_sale && $sale_price ) : ?>
									<del>
								<?php endif; ?>
					...
					<div class="clearfix" >
						...
						if ( wp_travel_tab_show_in_menu( 'reviews' ) ) { ?>
							...
							<span class="rating-count"><?php printf( esc_html__('( %s Reviews )', 'travel-log'), wp_travel_get_rating_count() ); ?></span>
						<?php }
						?>
