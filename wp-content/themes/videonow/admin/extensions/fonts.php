...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'videonow' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'videonow' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'videonow' ),
		'cyrillic'     => __( 'Cyrillic', 'videonow' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'videonow' ),
		'devanagari'   => __( 'Devanagari', 'videonow' ),
		'greek'        => __( 'Greek', 'videonow' ),
		'greek-ext'    => __( 'Greek Extended', 'videonow' ),
		'khmer'        => __( 'Khmer', 'videonow' ),
		'latin'        => __( 'Latin', 'videonow' ),
		'latin-ext'    => __( 'Latin Extended', 'videonow' ),
		'vietnamese'   => __( 'Vietnamese', 'videonow' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'videonow' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'videonow' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'videonow' ),
