                                    ...
                                    <?php } ?>
                                      ...
                                      <?php
                                        ...
                                        if( class_exists( 'Wp_Travel_Engine_Group_Discount' ) && isset( $wp_travel_engine_setting['group']['discount'] ) && isset( $wp_travel_engine_setting['group']['traveler'] ) && ! empty( $wp_travel_engine_setting['group']['traveler'] ) ){ ?>
                                                <span class="group-discount"><span class="tooltip"><?php _e( 'You have group discount in this trip.', 'wp-travel-engine-companion' ) ?></span><?php _e( 'Group Discount', 'wp-travel-engine-companion' ) ?></span>
                                                <?php
                                            }
                                            ?>    
                                </div>
                                        ...
                                        <div class="star-holder">
                                            <?php
                                                ...
                                                if ( !empty( $comments ) ){
                                                    ...
                                                    <span class="rating-star" itemprop="ratingValue">'.$aggregate.'</span><span itemprop="reviewCount">'.$i.'</span> '. esc_html( _nx( 'review', 'reviews', $i, 'reviews count', 'wp-travel-engine-companion' ) ) .'</div>';
                                    ...
                                    if( class_exists('WTE_Fixed_Starting_Dates') ){ 
                                        ...
                                        if( ! empty( $starting_dates ) && $starting_dates[0] != '' && is_array($starting_dates) ){ ?>
                                            <div class="next-trip-info">
                                                <?php echo '<h3>'.esc_html__( 'Next Departure', 'wte-fixed-departure-dates' ).'</h3>'; ?>
