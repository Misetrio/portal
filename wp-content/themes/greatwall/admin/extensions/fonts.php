...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'greatwall' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'greatwall' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'greatwall' ),
		'cyrillic'     => __( 'Cyrillic', 'greatwall' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'greatwall' ),
		'devanagari'   => __( 'Devanagari', 'greatwall' ),
		'greek'        => __( 'Greek', 'greatwall' ),
		'greek-ext'    => __( 'Greek Extended', 'greatwall' ),
		'khmer'        => __( 'Khmer', 'greatwall' ),
		'latin'        => __( 'Latin', 'greatwall' ),
		'latin-ext'    => __( 'Latin Extended', 'greatwall' ),
		'vietnamese'   => __( 'Vietnamese', 'greatwall' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'greatwall' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'greatwall' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'greatwall' ),
