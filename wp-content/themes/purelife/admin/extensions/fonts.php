...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'purelife' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'purelife' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'purelife' ),
		'cyrillic'     => __( 'Cyrillic', 'purelife' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'purelife' ),
		'devanagari'   => __( 'Devanagari', 'purelife' ),
		'greek'        => __( 'Greek', 'purelife' ),
		'greek-ext'    => __( 'Greek Extended', 'purelife' ),
		'khmer'        => __( 'Khmer', 'purelife' ),
		'latin'        => __( 'Latin', 'purelife' ),
		'latin-ext'    => __( 'Latin Extended', 'purelife' ),
		'vietnamese'   => __( 'Vietnamese', 'purelife' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'purelife' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'purelife' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'purelife' ),
