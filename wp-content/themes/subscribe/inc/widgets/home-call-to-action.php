...
class subscribe_Action extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'subscribe_action_widget', 'description' => __( 'Display a call to action block.', 'subscribe') );
        parent::__construct(false, $name = __('Home - Call to action', 'subscribe'), $widget_ops);
		$this->alt_option_name = 'subscribe_action_widget';		
    }
	...
	<p><label for="<?php echo $this->get_field_id('action_text'); ?>"><?php _e('Enter your call to action.', 'subscribe'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_link'); ?>"><?php _e('Link for the button', 'subscribe'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_text'); ?>"><?php _e('Title for the button', 'subscribe'); ?></label>
	...
	<label for="<?php echo $this->get_field_id( 'inline' ); ?>"><?php _e( 'Display the button inline with the text?', 'subscribe' ); ?></label></p>
	<?php
	}
