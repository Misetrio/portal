 ...
 * Set import files
 */
function videocloud_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Demo content', 'videocloud'),
...
add_filter( 'pt-ocdi/import_files', 'videocloud_set_import_files' );

/**
 * Define actions that happen after import
 */
function videocloud_set_after_import_mods() {
...
add_action( 'pt-ocdi/after_import', 'videocloud_set_after_import_mods' );
