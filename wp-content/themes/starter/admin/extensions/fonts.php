...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'starter' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'starter' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'starter' ),
		'cyrillic'     => __( 'Cyrillic', 'starter' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'starter' ),
		'devanagari'   => __( 'Devanagari', 'starter' ),
		'greek'        => __( 'Greek', 'starter' ),
		'greek-ext'    => __( 'Greek Extended', 'starter' ),
		'khmer'        => __( 'Khmer', 'starter' ),
		'latin'        => __( 'Latin', 'starter' ),
		'latin-ext'    => __( 'Latin Extended', 'starter' ),
		'vietnamese'   => __( 'Vietnamese', 'starter' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'starter' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'starter' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'starter' ),
