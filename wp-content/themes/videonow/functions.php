<?php
/**
 * VideoNow functions and definitions.
 *
...
if ( ! function_exists( 'videonow_setup' ) ) :

function videonow_setup() {

	load_theme_textdomain( 'videonow', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'videonow' ),
		'footer' => esc_html__( 'Footer Menu', 'videonow' ),		
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'videonow_custom_background_args', array(
...
add_action( 'after_setup_theme', 'videonow_setup' );
 ...
 */
function videonow_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'videonow_content_width', 650 );
}
add_action( 'after_setup_theme', 'videonow_content_width', 0 );
 ...
 */
function videonow_sidebar_init() {
	register_sidebar(
		array(
			'name'          => __( 'Home Content Area', 'videonow' ),
			'id'            => 'homepage',
			'description'   => __( 'Only display the "Home Posts Block" widget.', 'videonow' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'videonow' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'videonow' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 1', 'videonow' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add widgets here.', 'videonow' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 2', 'videonow' ),
		'id'            => 'footer-2',
		'description'   => esc_html__( 'Add widgets here.', 'videonow' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 3', 'videonow' ),
		'id'            => 'footer-3',
		'description'   => esc_html__( 'Add widgets here.', 'videonow' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 4', 'videonow' ),
		'id'            => 'footer-4',
		'description'   => esc_html__( 'Add widgets here.', 'videonow' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
...
add_action( 'widgets_init', 'videonow_sidebar_init' );
...
function videonow_scripts() {
    ...
    // Enqueues CSS styles
    wp_enqueue_style( 'videonow-style', get_stylesheet_uri(), array(), '20180523' );     
...
add_action( 'wp_enqueue_scripts', 'videonow_scripts' );

/* Admin CSS Style */
function videonow_admin_style() {
	wp_enqueue_style('admin-styles', get_template_directory_uri().'/assets/css/admin.css');
}
add_action('admin_enqueue_scripts', 'videonow_admin_style');
 ...
 */
function videonow_widgets_init() {

	require trailingslashit( get_template_directory() ) . 'inc/widgets/widget-home-posts-block.php';
	register_widget( 'videonow_Posts_Block_Widget' );	

}
add_action( 'widgets_init', 'videonow_widgets_init' );
