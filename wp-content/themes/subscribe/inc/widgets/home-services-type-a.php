...
class subscribe_Services_Type_A extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'subscribe_services_widget', 'description' => __( 'Show what services you are able to provide.', 'subscribe') );
        parent::__construct(false, $name = __('Home - Services - A', 'subscribe'), $widget_ops);
		$this->alt_option_name = 'subscribe_services_widget';
	...
	<label for="<?php echo $this->get_field_id( 'two_cols' ); ?>"><?php _e( 'Display services in two columns instead of three?', 'subscribe' ); ?></label></p>
