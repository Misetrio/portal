<?php
/**
 * purelife functions and definitions.
 *
...
function purelife_scripts() {
    ...
    // Enqueues CSS styles
    wp_enqueue_style( 'purelife-style', get_stylesheet_uri(), array(), '20180523' );     
...
/* Admin CSS Style */
function purelife_admin_style() {
	wp_enqueue_style('admin-styles', get_template_directory_uri().'/assets/css/admin.css');
}
add_action('admin_enqueue_scripts', 'purelife_admin_style');
