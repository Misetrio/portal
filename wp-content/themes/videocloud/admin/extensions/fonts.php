...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'videocloud' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'videocloud' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'videocloud' ),
		'cyrillic'     => __( 'Cyrillic', 'videocloud' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'videocloud' ),
		'devanagari'   => __( 'Devanagari', 'videocloud' ),
		'greek'        => __( 'Greek', 'videocloud' ),
		'greek-ext'    => __( 'Greek Extended', 'videocloud' ),
		'khmer'        => __( 'Khmer', 'videocloud' ),
		'latin'        => __( 'Latin', 'videocloud' ),
		'latin-ext'    => __( 'Latin Extended', 'videocloud' ),
		'vietnamese'   => __( 'Vietnamese', 'videocloud' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'videocloud' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'videocloud' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'videocloud' ),
