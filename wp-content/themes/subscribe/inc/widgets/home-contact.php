...
class subscribe_Home_Contact_Info extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'subscribe_contact_widget', 'description' => __( 'Display your contact info on your front page', 'subscribe') );
        parent::__construct(false, $name = __('Home - Contact', 'subscribe'), $widget_ops);
		$this->alt_option_name = 'subscribe_contact_widget';
	...
	<p><label for="<?php echo $this->get_field_id( 'above_address' ); ?>"><?php _e( 'A short call to action above your address', 'subscribe' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e( 'Enter your address', 'subscribe' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'above_phone' ); ?>"><?php _e( 'A short call to action above your phone number', 'subscribe' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php _e( 'Enter your phone number', 'subscribe' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'above_email' ); ?>"><?php _e( 'A short call to action above your email address', 'subscribe' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'email' ); ?>"><?php _e( 'Enter your email address', 'subscribe' ); ?></label>
