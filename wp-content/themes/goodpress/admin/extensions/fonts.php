...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'goodpress' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'goodpress' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'goodpress' ),
		'cyrillic'     => __( 'Cyrillic', 'goodpress' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'goodpress' ),
		'devanagari'   => __( 'Devanagari', 'goodpress' ),
		'greek'        => __( 'Greek', 'goodpress' ),
		'greek-ext'    => __( 'Greek Extended', 'goodpress' ),
		'khmer'        => __( 'Khmer', 'goodpress' ),
		'latin'        => __( 'Latin', 'goodpress' ),
		'latin-ext'    => __( 'Latin Extended', 'goodpress' ),
		'vietnamese'   => __( 'Vietnamese', 'goodpress' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'goodpress' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'goodpress' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'goodpress' ),
