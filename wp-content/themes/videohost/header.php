...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header clear">
			...
			<nav id="primary-nav" class="main-navigation">
				...
				?>
					...
					<ul id="primary-menu" class="sf-menu">
						<li><a href="<?php echo home_url(); ?>/wp-admin/nav-menus.php"><?php echo __('Add menu for: Primary Menu', 'videohost'); ?></a></li>
					</ul><!-- .sf-menu -->
			...
			<nav id="secondary-nav" class="secondary-navigation">
				...
				?>
					...
					<ul id="secondary-menu" class="sf-menu">
						<li><a href="<?php echo home_url(); ?>/wp-admin/nav-menus.php"><?php echo __('Add menu for: Secondary Menu', 'videohost'); ?></a></li>
					</ul><!-- .sf-menu -->
			...
			<?php if ( get_theme_mod('header-search-on', true) ) : ?>
				...
				<div class="header-search">
					<form id="searchform" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						...
						<button type="submit" class="search-submit"><?php echo __('Search', 'videohost'); ?></button>		
					</form>
				</div><!-- .header-search -->
		...
		<span class="mobile-menu-icon">
			<span class="menu-icon-open"><?php echo __('Menu', 'videohost'); ?></span>
		...
		<div class="mobile-menu clear">
			...
			<?php 
				...
				if ( has_nav_menu( 'primary' ) ) {
					...
					echo '<h3>' . get_theme_mod('primary-nav-heading', __('Pages', 'videohost')) . '</h3>';
				...
				if ( has_nav_menu( 'secondary' ) ) {
					...
					echo '<h3>' . get_theme_mod('secondary-nav-heading', __('Categories', 'videohost')) . '</h3>';
