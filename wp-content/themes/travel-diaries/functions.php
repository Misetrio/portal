...
function travel_diaries_scripts() {
    ...
    wp_enqueue_style( 'sidr', get_template_directory_uri() . '/css' . $build . '/jquery.sidr' . $suffix . '.css' );
    ...
    wp_enqueue_script( 'sidr', get_template_directory_uri() . '/js' . $build . '/jquery.sidr' . $suffix . '.js', array('jquery'), '1.2.1', true );
