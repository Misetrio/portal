...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'subscribe' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'subscribe' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'subscribe' ),
		'cyrillic'     => __( 'Cyrillic', 'subscribe' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'subscribe' ),
		'devanagari'   => __( 'Devanagari', 'subscribe' ),
		'greek'        => __( 'Greek', 'subscribe' ),
		'greek-ext'    => __( 'Greek Extended', 'subscribe' ),
		'khmer'        => __( 'Khmer', 'subscribe' ),
		'latin'        => __( 'Latin', 'subscribe' ),
		'latin-ext'    => __( 'Latin Extended', 'subscribe' ),
		'vietnamese'   => __( 'Vietnamese', 'subscribe' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'subscribe' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'subscribe' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'subscribe' ),
