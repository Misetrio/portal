...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'course' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'course' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'course' ),
		'cyrillic'     => __( 'Cyrillic', 'course' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'course' ),
		'devanagari'   => __( 'Devanagari', 'course' ),
		'greek'        => __( 'Greek', 'course' ),
		'greek-ext'    => __( 'Greek Extended', 'course' ),
		'khmer'        => __( 'Khmer', 'course' ),
		'latin'        => __( 'Latin', 'course' ),
		'latin-ext'    => __( 'Latin Extended', 'course' ),
		'vietnamese'   => __( 'Vietnamese', 'course' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'course' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'course' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'course' ),
