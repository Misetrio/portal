...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Revolution Fonts', 'revolution' ) ) ) );
	$revolution_fonts = customizer_library_get_revolution_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'revolution' ) ) ) );
	 ...
	 */
	return apply_filters( 'customizer_library_all_fonts', array_merge( $heading1, $revolution_fonts, $heading2, $google_fonts ) );
}
endif;
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'revolution' ),
		'cyrillic'     => __( 'Cyrillic', 'revolution' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'revolution' ),
		'devanagari'   => __( 'Devanagari', 'revolution' ),
		'greek'        => __( 'Greek', 'revolution' ),
		'greek-ext'    => __( 'Greek Extended', 'revolution' ),
		'khmer'        => __( 'Khmer', 'revolution' ),
		'latin'        => __( 'Latin', 'revolution' ),
		'latin-ext'    => __( 'Latin Extended', 'revolution' ),
		'vietnamese'   => __( 'Vietnamese', 'revolution' ),
	);
}
endif;
...
if ( ! function_exists( 'customizer_library_get_revolution_fonts' ) ) :
/**
 * Return an array of revolution websafe fonts.
 *
 * @since  1.0.0.
 *
 * @return array    Revolution websafe fonts.
 */
function customizer_library_get_revolution_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'revolution' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'revolution' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'revolution' ),
...
function customizer_library_get_google_fonts() {
	return apply_filters( 'customizer_library_get_google_fonts', array(
		...
		'Old Revolution TT' => array(
			'label'    => 'Old Revolution TT',
			'variants' => array(
				'regular',
				'italic',
				'700',
