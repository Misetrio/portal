...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'newsblock' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'newsblock' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'newsblock' ),
		'cyrillic'     => __( 'Cyrillic', 'newsblock' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'newsblock' ),
		'devanagari'   => __( 'Devanagari', 'newsblock' ),
		'greek'        => __( 'Greek', 'newsblock' ),
		'greek-ext'    => __( 'Greek Extended', 'newsblock' ),
		'khmer'        => __( 'Khmer', 'newsblock' ),
		'latin'        => __( 'Latin', 'newsblock' ),
		'latin-ext'    => __( 'Latin Extended', 'newsblock' ),
		'vietnamese'   => __( 'Vietnamese', 'newsblock' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'newsblock' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'newsblock' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'newsblock' ),
