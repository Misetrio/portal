 ...
 * @since      1.0.0
 */
class subscribe_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-subscribe-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'subscribe' )
		);

		// Create the widget.
		parent::__construct(
			'subscribe-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'subscribe' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'subscribe' ),
			'limit'     => 5,
			'show_date' => true
		);
