...
class subscribe_Contact_Info extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'subscribe_contact_info_widget', 'description' => __( 'Display your contact info', 'subscribe') );
        parent::__construct(false, $name = __('&raquo; Contact info', 'subscribe'), $widget_ops);
		$this->alt_option_name = 'subscribe_contact_info';		
    }
