...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'goodsite' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'goodsite' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'goodsite' ),
		'cyrillic'     => __( 'Cyrillic', 'goodsite' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'goodsite' ),
		'devanagari'   => __( 'Devanagari', 'goodsite' ),
		'greek'        => __( 'Greek', 'goodsite' ),
		'greek-ext'    => __( 'Greek Extended', 'goodsite' ),
		'khmer'        => __( 'Khmer', 'goodsite' ),
		'latin'        => __( 'Latin', 'goodsite' ),
		'latin-ext'    => __( 'Latin Extended', 'goodsite' ),
		'vietnamese'   => __( 'Vietnamese', 'goodsite' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'goodsite' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'goodsite' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'goodsite' ),
