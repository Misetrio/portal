...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'makemoney' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'makemoney' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'makemoney' ),
		'cyrillic'     => __( 'Cyrillic', 'makemoney' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'makemoney' ),
		'devanagari'   => __( 'Devanagari', 'makemoney' ),
		'greek'        => __( 'Greek', 'makemoney' ),
		'greek-ext'    => __( 'Greek Extended', 'makemoney' ),
		'khmer'        => __( 'Khmer', 'makemoney' ),
		'latin'        => __( 'Latin', 'makemoney' ),
		'latin-ext'    => __( 'Latin Extended', 'makemoney' ),
		'vietnamese'   => __( 'Vietnamese', 'makemoney' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'makemoney' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'makemoney' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'makemoney' ),
