 ...
 * @since      1.0.0
 */
class GoodSite_Ad_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'Display any kinds of advertisements.', 'goodsite' ),
		...
		parent::__construct(
			...
			esc_html__( '&raquo; Advertisement', 'goodsite' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_code' ); ?>">
				<?php esc_html_e( 'Ad Code', 'goodsite' ); ?>
			</label>
