...
class GreatWall_Pro_Skills extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'greawall_pro_skills_widget', 'description' => __( 'Show your visitors some of your skills.', 'greatwall') );
        parent::__construct(false, $name = __('Home - Skills', 'greatwall'), $widget_ops);
		$this->alt_option_name = 'greawall_pro_skills_widget';
	...
	<!-- skill one -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_one'); ?>"><?php _e('First skill name', 'greatwall'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_one_max'); ?>"><?php _e('First skill value', 'greatwall'); ?></label>
	...
	<!-- skill two -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_two'); ?>"><?php _e('Second skill name', 'greatwall'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_two_max'); ?>"><?php _e('Second skill value', 'greatwall'); ?></label>
	...
	<!-- skill three -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_three'); ?>"><?php _e('Third skill name', 'greatwall'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_three_max'); ?>"><?php _e('Third skill value', 'greatwall'); ?></label>
	...
	<!-- skill four -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_four'); ?>"><?php _e('Fourth skill name', 'greatwall'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_four_max'); ?>"><?php _e('Fourth skill value', 'greatwall'); ?></label>
