...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Improve Fonts', 'improve' ) ) ) );
	$improve_fonts = customizer_library_get_improve_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'improve' ) ) ) );
	 ...
	 */
	return apply_filters( 'customizer_library_all_fonts', array_merge( $heading1, $improve_fonts, $heading2, $google_fonts ) );
}
endif;
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'improve' ),
		'cyrillic'     => __( 'Cyrillic', 'improve' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'improve' ),
		'devanagari'   => __( 'Devanagari', 'improve' ),
		'greek'        => __( 'Greek', 'improve' ),
		'greek-ext'    => __( 'Greek Extended', 'improve' ),
		'khmer'        => __( 'Khmer', 'improve' ),
		'latin'        => __( 'Latin', 'improve' ),
		'latin-ext'    => __( 'Latin Extended', 'improve' ),
		'vietnamese'   => __( 'Vietnamese', 'improve' ),
	);
}
endif;
...
if ( ! function_exists( 'customizer_library_get_improve_fonts' ) ) :
/**
 * Return an array of improve websafe fonts.
 *
 * @since  1.0.0.
 *
 * @return array    Improve websafe fonts.
 */
function customizer_library_get_improve_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'improve' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'improve' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'improve' ),
...
function customizer_library_get_google_fonts() {
	return apply_filters( 'customizer_library_get_google_fonts', array(
		...
		'Old Improve TT' => array(
			'label'    => 'Old Improve TT',
			'variants' => array(
				'regular',
				'italic',
				'700',
