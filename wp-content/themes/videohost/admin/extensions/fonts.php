...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'videohost' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'videohost' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'videohost' ),
		'cyrillic'     => __( 'Cyrillic', 'videohost' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'videohost' ),
		'devanagari'   => __( 'Devanagari', 'videohost' ),
		'greek'        => __( 'Greek', 'videohost' ),
		'greek-ext'    => __( 'Greek Extended', 'videohost' ),
		'khmer'        => __( 'Khmer', 'videohost' ),
		'latin'        => __( 'Latin', 'videohost' ),
		'latin-ext'    => __( 'Latin Extended', 'videohost' ),
		'vietnamese'   => __( 'Vietnamese', 'videohost' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'videohost' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'videohost' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'videohost' ),
