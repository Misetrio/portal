 ...
 * @since      1.0.0
 */
class subscribe_Newsletter_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'Display newsletter subscribe form.', 'subscribe' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'subscribe-newsletter',                                    // $this->id_base
			esc_html__( '&raquo; Newsletter', 'subscribe' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>">
				<?php esc_html_e( 'Title', 'subscribe' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'form_code' ); ?>">
				<?php esc_html_e( 'Subscribe Form Code', 'subscribe' ); ?> <span style="display: block;color: #999;">See <a href="https://www.happythemes.com/demo/subscribe-pro/wp-content/themes/subscribe-pro/form-example.txt" target="_blank">example code</a>.</span>
			</label>
