...
class GreatWall_Pro_Action extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'greawall_pro_action_widget', 'description' => __( 'Display a call to action block.', 'greatwall') );
        parent::__construct(false, $name = __('Home - Call to action', 'greatwall'), $widget_ops);
		$this->alt_option_name = 'greawall_pro_action_widget';		
    }
	...
	<p><label for="<?php echo $this->get_field_id('action_text'); ?>"><?php _e('Enter your call to action.', 'greatwall'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_link'); ?>"><?php _e('Link for the button', 'greatwall'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_text'); ?>"><?php _e('Title for the button', 'greatwall'); ?></label>
	...
	<label for="<?php echo $this->get_field_id( 'inline' ); ?>"><?php _e( 'Display the button inline with the text?', 'greatwall' ); ?></label></p>
	<?php
	}
