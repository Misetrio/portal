...
class subscribe_Facts extends WP_Widget {

// constructor
	public function __construct() {
		$widget_ops = array('classname' => 'subscribe_facts_widget', 'description' => __( 'Show your visitors some facts about your company.', 'subscribe') );
        parent::__construct(false, $name = __('Home - Facts', 'subscribe'), $widget_ops);
		$this->alt_option_name = 'subscribe_facts_widget';
    }
	...
	?>
	<p><?php _e('You can find a list of the available icons ', 'subscribe'); ?><a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_blank"><?php _e('here.', 'subscribe'); ?></a>&nbsp;<?php _e('Usage example: <strong>fa-android</strong>', 'subscribe'); ?></p>
	<p>
	...
	<!-- fact one -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_one'); ?>"><?php _e('First fact name', 'subscribe'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_one_max'); ?>"><?php _e('First fact value', 'subscribe'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_one_icon'); ?>"><?php _e('First fact icon', 'subscribe'); ?></label>
	...
	<!-- fact two -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_two'); ?>"><?php _e('Second fact name', 'subscribe'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_two_max'); ?>"><?php _e('Second fact value', 'subscribe'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_two_icon'); ?>"><?php _e('Second fact icon', 'subscribe'); ?></label>
	...
	<!-- fact three -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_three'); ?>"><?php _e('Third fact name', 'subscribe'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_three_max'); ?>"><?php _e('Third fact value', 'subscribe'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_three_icon'); ?>"><?php _e('Third fact icon', 'subscribe'); ?></label>
	...
	<!-- fact four -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_four'); ?>"><?php _e('Fourth fact name', 'subscribe'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_four_max'); ?>"><?php _e('Fourth fact value', 'subscribe'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_four_icon'); ?>"><?php _e('Fourth fact icon', 'subscribe'); ?></label>
